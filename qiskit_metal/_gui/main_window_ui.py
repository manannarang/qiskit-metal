...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QtCore.QObject.connect(self.actionElements, QtCore.SIGNAL("toggled(bool)"), MainWindow._set_element_tab)
        QtCore.QObject.connect(self.actionDelete_All, QtCore.SIGNAL("triggered()"), MainWindow.delete_all_components)
        QtCore.QObject.connect(self.actionLoad, QtCore.SIGNAL("triggered()"), MainWindow.load_design)
        QtCore.QObject.connect(self.actionSave, QtCore.SIGNAL("triggered()"), MainWindow.save_design)
        QtCore.QObject.connect(self.actionStyleDark, QtCore.SIGNAL("triggered()"), MainWindow.load_stylesheet_dark)
        QtCore.QObject.connect(self.actionStyleDefault, QtCore.SIGNAL("triggered()"), MainWindow.load_stylesheet_default)
        QtCore.QObject.connect(self.actionScreenshot, QtCore.SIGNAL("triggered()"), MainWindow._screenshot)
        QtCore.QObject.connect(self.actionStyleOpen, QtCore.SIGNAL("triggered()"), MainWindow.load_stylesheet_open)
        QtCore.QObject.connect(self.action_full_refresh, QtCore.SIGNAL("triggered()"), MainWindow.full_refresh)
        QtCore.QObject.connect(self.actionRebuild, QtCore.SIGNAL("triggered()"), MainWindow.rebuild)
        QtCore.QObject.connect(self.actionFull_Screen, QtCore.SIGNAL("triggered()"), MainWindow.showFullScreen)
        QtCore.QObject.connect(self.actionMetal_Dark, QtCore.SIGNAL("triggered()"), MainWindow.load_stylesheet_metal_dark)
        QtCore.QObject.connect(self.dockDesign, QtCore.SIGNAL("visibilityChanged(bool)"), self.actionDesign.setChecked)
        QtCore.QObject.connect(self.actionDesign, QtCore.SIGNAL("triggered(bool)"), self.dockDesign.show)
        QtCore.QObject.connect(self.dockConnectors, QtCore.SIGNAL("visibilityChanged(bool)"), self.actionConnectors.setChecked)
        QtCore.QObject.connect(self.dockLog, QtCore.SIGNAL("visibilityChanged(bool)"), self.actionLog.setChecked)
        QtCore.QObject.connect(self.dockLibrary, QtCore.SIGNAL("visibilityChanged(bool)"), self.actionNewComponent.setChecked)
        QtCore.QObject.connect(self.actionNewComponent, QtCore.SIGNAL("triggered(bool)"), self.dockLibrary.show)
        QtCore.QObject.connect(self.actionLog, QtCore.SIGNAL("triggered(bool)"), self.dockLog.show)
        QtCore.QObject.connect(self.actionConnectors, QtCore.SIGNAL("triggered(bool)"), self.dockConnectors.show)
        QtCore.QObject.connect(self.actionDesign, QtCore.SIGNAL("triggered()"), self.dockDesign.raise_)
        QtCore.QObject.connect(self.actionConnectors, QtCore.SIGNAL("triggered()"), self.dockConnectors.raise_)
        QtCore.QObject.connect(self.actionNewComponent, QtCore.SIGNAL("triggered()"), self.dockLibrary.raise_)
        QtCore.QObject.connect(self.actionElements, QtCore.SIGNAL("triggered()"), self.tabWidget.setFocus)
        QtCore.QObject.connect(self.actionLog, QtCore.SIGNAL("triggered()"), self.dockLog.raise_)
        QtCore.QObject.connect(self.actionSaveAs, QtCore.SIGNAL("toggled(bool)"), MainWindow.save_design_as)
        QtCore.QObject.connect(self.actionClose_window, QtCore.SIGNAL("triggered()"), MainWindow.close)
        QtCore.QObject.connect(self.actionSave_window_state, QtCore.SIGNAL("triggered()"), MainWindow.save_window_settings)
        ...
        QtCore.QObject.connect(self.actionDeveloperMode, QtCore.SIGNAL("toggled(bool)"), MainWindow.activate_developer_mode)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QtWidgets.QApplication.translate("MainWindow", "Qiskit Metal: Quantum Creator", None, -1))
        MainWindow.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Qiskit Metal: Quantum Creator", None, -1))
        MainWindow.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Qiskit Metal: Quantum Creator", None, -1))
        MainWindow.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "Qiskit Metal: Quantum Creator", None, -1))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.mainViewTab), QtWidgets.QApplication.translate("MainWindow", "Main View", None, -1))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabElements), QtWidgets.QApplication.translate("MainWindow", "Elements", None, -1))
        self.tabWidget.setTabToolTip(self.tabWidget.indexOf(self.tabElements), QtWidgets.QApplication.translate("MainWindow", "Shoe the tables of elements of the the design", None, -1))
        self.menuDesign.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Design Menu", None, -1))
        self.menuDesign.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Design Menu", None, -1))
        self.menuDesign.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "Design Menu", None, -1))
        self.menuDesign.setTitle(QtWidgets.QApplication.translate("MainWindow", "Metal Design", None, -1))
        self.menuView.setTitle(QtWidgets.QApplication.translate("MainWindow", "Window View", None, -1))
        self.menuStylesheet.setTitle(QtWidgets.QApplication.translate("MainWindow", "Color theme", None, -1))
        self.menuAnalysis.setTitle(QtWidgets.QApplication.translate("MainWindow", "Analysis", None, -1))
        self.menuRender.setTitle(QtWidgets.QApplication.translate("MainWindow", "Render", None, -1))
        self.menuHelp.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Open Metal Help", None, -1))
        self.menuHelp.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Open Metal Help", None, -1))
        self.menuHelp.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "Open Metal Help", None, -1))
        self.menuHelp.setTitle(QtWidgets.QApplication.translate("MainWindow", "Help", None, -1))
        self.menuPlot.setTitle(QtWidgets.QApplication.translate("MainWindow", "Plot", None, -1))
        self.toolBarDesign.setWindowTitle(QtWidgets.QApplication.translate("MainWindow", "Design toolbar", None, -1))
        self.toolBarDesign.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Design toolbar", None, -1))
        self.toolBarDesign.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "Design toolbar", None, -1))
        self.toolBarView.setWindowTitle(QtWidgets.QApplication.translate("MainWindow", "View Toolbar", None, -1))
        self.toolBarView.setToolTip(QtWidgets.QApplication.translate("MainWindow", "View Toolbar", None, -1))
        self.toolBarView.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "View Toolbar", None, -1))
        self.toolBarView.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "View Toolbar", None, -1))
        self.dockDesign.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Design Dock", None, -1))
        self.dockDesign.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Design Dock", None, -1))
        self.dockDesign.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "Design Dock", None, -1))
        self.dockDesign.setAccessibleName(QtWidgets.QApplication.translate("MainWindow", "Design Dock", None, -1))
        self.dockDesign.setAccessibleDescription(QtWidgets.QApplication.translate("MainWindow", "Design Dock", None, -1))
        self.dockDesign.setWindowTitle(QtWidgets.QApplication.translate("MainWindow", "QComponents", None, -1))
        self.btn_comp_zoom.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Focus on component in drawing window", None, -1))
        self.btn_comp_zoom.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Focus on component in drawing window", None, -1))
        self.btn_comp_zoom.setText(QtWidgets.QApplication.translate("MainWindow", "Focus on component in drawing window", None, -1))
        self.btn_comp_actions.setText(QtWidgets.QApplication.translate("MainWindow", "Do", None, -1))
        self.btn_comp_del.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Delete a selected component", None, -1))
        self.btn_comp_del.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Delete a selected component", None, -1))
        self.btn_comp_del.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "Delete a selected component", None, -1))
        self.btn_comp_del.setText(QtWidgets.QApplication.translate("MainWindow", "Delete", None, -1))
        self.filter_text_design.setPlaceholderText(QtWidgets.QApplication.translate("MainWindow", "Filter", None, -1))
        self.dockLibrary.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Library of components", None, -1))
        self.dockLibrary.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Library design components", None, -1))
        self.dockLibrary.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "Library design components", None, -1))
        self.dockLibrary.setWindowTitle(QtWidgets.QApplication.translate("MainWindow", "Library", None, -1))
        self.dockComponent.setWindowTitle(QtWidgets.QApplication.translate("MainWindow", "Edit component", None, -1))
        self.dockLog.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Log window", None, -1))
        self.dockLog.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Log window", None, -1))
        self.dockLog.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "Log window", None, -1))
        self.dockLog.setWindowTitle(QtWidgets.QApplication.translate("MainWindow", "Log", None, -1))
        self.log_text.setDocumentTitle(QtWidgets.QApplication.translate("MainWindow", "Log", None, -1))
        self.dockConnectors.setWindowTitle(QtWidgets.QApplication.translate("MainWindow", "Pins", None, -1))
        self.text_filter_connectors.setPlaceholderText(QtWidgets.QApplication.translate("MainWindow", "Filter", None, -1))
        self.dockVariables.setWindowTitle(QtWidgets.QApplication.translate("MainWindow", "Variables", None, -1))
        self.toolbar_renderers.setWindowTitle(QtWidgets.QApplication.translate("MainWindow", "toolBar", None, -1))
        self.actionSave.setText(QtWidgets.QApplication.translate("MainWindow", "Save", None, -1))
        self.actionSave.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Save design to file", None, -1))
        self.actionSave.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Save design to file", None, -1))
        self.actionSave.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "Save design to file", None, -1))
        ...
        self.actionLoad.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Load design from file", None, -1))
        self.actionLoad.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Load design from file", None, -1))
        self.actionLoad.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "Load design from file", None, -1))
        self.actionLoad.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+O", None, -1))
        self.actionDesign.setText(QtWidgets.QApplication.translate("MainWindow", "Select component", None, -1))
        self.actionDesign.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Show design window -- select components (show/hide)", None, -1))
        self.actionDesign.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+D", None, -1))
        self.actionElements.setText(QtWidgets.QApplication.translate("MainWindow", "Elements", None, -1))
        self.actionElements.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Show/hide elements table", None, -1))
        self.actionLog.setText(QtWidgets.QApplication.translate("MainWindow", "Log", None, -1))
        self.actionLog.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Show/hide log window", None, -1))
        self.actionLog.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+L", None, -1))
        self.actionNewComponent.setText(QtWidgets.QApplication.translate("MainWindow", "Create", None, -1))
        self.actionNewComponent.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Create new component: Library of new design components you can create", None, -1))
        self.actionNewComponent.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Create new component: Library of new design components you can create", None, -1))
        self.actionNewComponent.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "Create new component: Library of new design components you can create", None, -1))
        self.actionNewComponent.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+N", None, -1))
        self.actionDelete_All.setText(QtWidgets.QApplication.translate("MainWindow", "Delete all", None, -1))
        self.actionDelete_All.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Delete All Component Objects and Elements", None, -1))
        self.actionDelete_All.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Delete All Component Objects and Elements", None, -1))
        self.actionDelete_All.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "Delete All Component Objects and Elements", None, -1))
        self.actionZoom.setText(QtWidgets.QApplication.translate("MainWindow", "Zoom", None, -1))
        self.actionZoom.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Zoom control", None, -1))
        self.actionZoom.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Z", None, -1))
        self.actionPan.setText(QtWidgets.QApplication.translate("MainWindow", "Pan", None, -1))
        self.actionPan.setShortcut(QtWidgets.QApplication.translate("MainWindow", "P", None, -1))
        self.actionConnectors.setText(QtWidgets.QApplication.translate("MainWindow", "Pins", None, -1))
        self.actionConnectors.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Show connector pins of qcomponents", None, -1))
        self.actionConnectors.setShortcut(QtWidgets.QApplication.translate("MainWindow", "C", None, -1))
        self.actionStyleOpen.setText(QtWidgets.QApplication.translate("MainWindow", "Open File", None, -1))
        self.actionStyleDefault.setText(QtWidgets.QApplication.translate("MainWindow", "System default", None, -1))
        self.actionStyleDark.setText(QtWidgets.QApplication.translate("MainWindow", "Q Dark", None, -1))
        self.actionScreenshot.setText(QtWidgets.QApplication.translate("MainWindow", "Screenshot", None, -1))
        self.actionScreenshot.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Take a screenshot of the window", None, -1))
        self.action_full_refresh.setText(QtWidgets.QApplication.translate("MainWindow", "Replot", None, -1))
        self.action_full_refresh.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Replot all components (and refresh all gui widgets). Does NOT REBUILD", None, -1))
        self.action_full_refresh.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Force a full refresh of all plots and widgets", None, -1))
        self.action_full_refresh.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "Force a full refresh of all plots and widgets", None, -1))
        self.action_full_refresh.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+R", None, -1))
        self.actionRebuild.setText(QtWidgets.QApplication.translate("MainWindow", "Rebuild", None, -1))
        self.actionRebuild.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Force rebuild all components", None, -1))
        self.actionRebuild.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Force rebuild all components", None, -1))
        self.actionRebuild.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "Force rebuild all components", None, -1))
        self.actionRebuild.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+D", None, -1))
        self.actionFull_Screen.setText(QtWidgets.QApplication.translate("MainWindow", "Full Screen", None, -1))
        self.actionFull_Screen.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Go to full screen", None, -1))
        self.actionMetal_Dark.setText(QtWidgets.QApplication.translate("MainWindow", "Metal Dark", None, -1))
        self.actionSaveAs.setText(QtWidgets.QApplication.translate("MainWindow", "Save as", None, -1))
        self.actionSaveAs.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Save design to new file", None, -1))
        self.actionSaveAs.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Save design to file", None, -1))
        self.actionSaveAs.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "Save design to file", None, -1))
        self.actionSaveAs.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+Shift+S", None, -1))
        self.actionSave_window_state.setText(QtWidgets.QApplication.translate("MainWindow", "Save window state", None, -1))
        self.actionLabelDesign.setText(QtWidgets.QApplication.translate("MainWindow", "Design", None, -1))
        self.actionClose_window.setText(QtWidgets.QApplication.translate("MainWindow", "Close window", None, -1))
        self.actionMetal_Window.setText(QtWidgets.QApplication.translate("MainWindow", "Metal Window ", None, -1))
        self.actionViewDummyLabel.setText(QtWidgets.QApplication.translate("MainWindow", "View", None, -1))
        self.actionVariables.setText(QtWidgets.QApplication.translate("MainWindow", "Design variables", None, -1))
        self.actionVariables.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Edit variables of the QDesign", None, -1))
        self.actionVariables.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Meta+V", None, -1))
        self.actionToggleDocks.setText(QtWidgets.QApplication.translate("MainWindow", "Toggle view", None, -1))
        self.actionToggleDocks.setToolTip(QtWidgets.QApplication.translate("MainWindow", "ToggleDocks", None, -1))
        self.actionToggleDocks.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Meta+F, Ctrl+F", None, -1))
        self.actionGDS.setText(QtWidgets.QApplication.translate("MainWindow", "GDS", None, -1))
        ...
        self.actionDeveloperMode.setText(QtWidgets.QApplication.translate("MainWindow", "DeveloperMode", None, -1))
        self.actionDeveloperMode.setToolTip(QtWidgets.QApplication.translate("MainWindow", "clickme", None, -1))
